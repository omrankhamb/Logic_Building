...
void ManPageDisplay(char Name[])
{
    ...
    else if(strcmp(Name,"creat") == 0)
    {
        ...
        printf("File_Name : Name if file that we want to creat\n");
    ...
    {
        printf("About : It is used to existing the unlink file name\n");
    ...
    else if(strcmp(Name,"stat") == 0)
    {
        ...
        printf("File_Name : Name of the file whose information should be fetch\n");
...
//  Description :       It is used to Dlete the 
//                      specific file
//  Input :             File Name
//  Output :            Exit status of function
//  Author :            Piyush Manohar Khairnar
               ...
               )
{
    ...
    for(i = 0 ; i  < MAXOPENFILES ; i++)
    {
        // UFDT is array of UAREA so uareaobj address not changin
        if(uareaobj.UFDT[i] != NULL)
        {
            if(strcmp(uareaobj.UFDT[i]->ptrinode->FileName,name) == 0)
            {
                ...
                uareaobj.UFDT[i]->ptrinode->Buffer = NULL;  // Pointing to null address
                ...
                // Store the address of filetable
    ...
    return EXECUTE_SUCCESS;
}// End of unlink file function

////////////////////////////////////////////////////
//
//  Function Name :     write_file()
//  Description :       It is used to write the 
//                      data in to specific  file
//  Input :             File Descriptor
//                      Data that we want to write
//                      Size of data
//  Output :            Number of bite successfully return
//  Author :            Piyush Manohar Khairnar
//  Date :              2/08/2026
//
//////////////////////////////////////////////////////
...
//  Description :       It is used to read from the 
//                      data in to specific  file
//  Input :             File Descriptor
//                      address of empty buffer
//                      Size of data
//  Output :            Number of bite successfully read
//  Author :            Piyush Manohar Khairnar
//  Date :              2/08/2026
//
//////////////////////////////////////////////////////
            ...
            )
{
    ...
    // filter for permssion
    if(uareaobj.UFDT[fd]->ptrinode->Permission < 1)
    {
        return ERR_PERMISSION_DENIED;
    }
    ...
    // Read the data
    // Base Address of offset address
...
int main()
{
    ...
    while(1)
    {
        ...
        if(iCount == 1)
        {
            ...
            // Marvellous CVFS : > ls            
            else if((strcmp(Command[0],"ls") == 0) && strcmp(Command[1], "-a"))
            {
                LsFile();
            }
            else
        ...
        else if(iCount == 2)
        {
            ...
            //Marvellous CVFS :> write 1 "1 File Descriptor"
            else if(strcmp(Command[0],"write") == 0)
            {
                ...
                {
                    printf("Invlid Parameter\n");
                    printf("Please refer ManPage for Information\n");
                }
                ...
                {
                    printf("%d Bytes get successfully in to the file\n",iRet);
                }
            }
            else
            {
        ...
        else if(iCount == 3)
        {
            ...
            // Marvellous CVFS : > read 3(File descriptor) 10 toal size to read
